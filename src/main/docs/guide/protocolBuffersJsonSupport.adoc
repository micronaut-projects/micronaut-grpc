...
snippet::helloworld.GreeterService[tags="imports,clazz", source="main"]

[.lang-python]
--
NOTE: A Python class cannot extend the generated `GreeterGrpc.GreeterImplBase` class: it implements `io.grpc.BindableService` and binds itself with `GreeterGrpc.bindService(self)`, see <<server, gRPC Server>>.
--
...
[source,protobuf]
----
include::test-suite/src/main/proto/greeter.proto[]
----
