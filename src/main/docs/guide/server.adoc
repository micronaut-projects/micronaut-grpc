...
----
- `cert-chain` specifies the file to load the certificate from.
- `private-key` specifies the classpath resource for the private key. The file should be in `src/main/resources/`.
