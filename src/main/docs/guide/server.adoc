...
snippet::helloworld.GreetingEndpoint[tags="imports,clazz", project-base="test-suite", source="main"]
...
snippet::helloworld.GreetingEndpointTest[tags="imports,test", project-base="test-suite"]
