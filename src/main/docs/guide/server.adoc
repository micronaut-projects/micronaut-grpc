...
The https://github.com/grpc/grpc/blob/master/doc/health-checking.md[gRPC health check protocol] is enabled by default.
To disable it, apply the following configuration:
