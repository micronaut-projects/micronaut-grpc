...
plugins {
    ...
include::test-suite/build.gradle[tags=plugin]
}
...
[source,groovy]
----
include::test-suite/build.gradle[tags=variables]

include::test-suite/build.gradle[tags=config]
----
...
[source,groovy]
----
include::test-suite/build.gradle[tags=reactive-variables]

dependencies {
...
include::test-suite/build.gradle[tags=reactive-dependencies]
}

sourceSets {
    main {
        java {
include::test-suite/build.gradle[tags=reactive-source-set]
        }
    }
}
...
protobuf {
...
include::test-suite/build.gradle[tags=reactive-plugin]
...
include::test-suite/build.gradle[tags=reactive-config]
}
----
...
[source,xml]
----
include::test-suite/pom.xml[tags=plugin, indent=0]
----
...
[source,protobuf]
----
include::test-suite/src/main/proto/helloworld.proto[]
----
