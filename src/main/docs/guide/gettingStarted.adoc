...
[source,groovy]
----
include::examples/hello-world-kotlin/build.gradle[tags=variables]

dependencies {
...
include::examples/hello-world-kotlin/build.gradle[tags=dependencies]
}

include::examples/hello-world-kotlin/build.gradle[tags=config]
